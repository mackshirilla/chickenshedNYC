...
(() => {
  ...
  async function addStudentOnLoad() {
    try {
  ...
  var additionalCare = document.getElementById("additionalCare");
  var additionalOverflow = document.getElementById("additionalOverflow");
  ...
  var familyOverflow = document.getElementById("familyOverflow");
  ...
  var studentContinue = document.getElementById("studentContinue");
