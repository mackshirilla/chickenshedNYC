...
(() => {
  ...
  // src/utils/requests/auth/requestPassword.ts
  async function requestPassword() {
    ...
    try {
      ...
      const url = `https://xszy-vp96-kdkh.n7c.xano.io/api:WyQO-hFi/auth/password-reset?email=${encodeURIComponent(
        email
      )}`;
...
//# sourceMappingURL=userRequestPasswordReset.js.map
